...
def load_corpus_config(corpus_name: str) -> CorpusConfig:
    ...
    cfg = CorpusConfig(
        ...
        pdf_dir=_resolve_path(paths.get("pdf_dir", f"data/institutional_policy/{corpus_name}")),
        ontology_path=_resolve_path(paths.get("ontology", f"data/shacl/ontology/{corpus_name}_policy_ontology.ttl")),
        vocabulary_path=_resolve_path(paths.get("vocabulary", f"data/shacl/ontology/{corpus_name}_property_list.txt")),
        gold_shapes_path=_resolve_path(paths.get("gold_shapes", f"data/shacl/shapes/{corpus_name}_policy_shapes.ttl")),
        test_data_path=_resolve_path(paths.get("test_data", f"data/shacl/test_data/{corpus_name}_test_data.ttl")),
