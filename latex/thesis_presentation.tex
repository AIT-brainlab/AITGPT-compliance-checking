...
\begin{frame}{Backup: How We Measured (TDD Evaluation)}
    ...
    \vspace{0.2cm}
    \textbf{Test-Driven Development approach} with 96 gold-standard shapes and 180 test entities:

    \vspace{0.2cm}
    \begin{enumerate}
        \item \textbf{Gold Standard}: 96 hand-written SHACL shapes (one per rule) with known-correct constraints
